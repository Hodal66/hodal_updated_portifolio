...
import { forgotPasswordUser, verifyResetOtp, resendOtp } from '../../services/api';
...
const ForgotPasswordPage = () => {
  ...
  useEffect(() => {
    if (isOtpComplete && step === 'otp' && !loading) {
      handleOtpSubmit();
    }
  }, [isOtpComplete, step]);
      ...
      <>
        <div className="text-center mb-8">
          ...
          <div className="w-16 h-16 rounded-2xl bg-primary-500/10 flex items-center justify-center mx-auto mb-6">
            <Icon icon="fluent:key-24-filled" width="36" className="text-primary-500" />
          </div>
  ...
  return (
    <>
      <div className="text-center mb-8">
        ...
        <div className="w-16 h-16 rounded-2xl bg-primary-500/10 flex items-center justify-center mx-auto mb-6">
          <Icon icon="fluent:shield-checkmark-24-filled" width="36" className="text-primary-500" />
        </div>
        <h1 className={`text-2xl font-bold mb-2 ${isDark ? 'text-white' : 'text-slate-900'}`}>
          Enter Reset Code
        </h1>
